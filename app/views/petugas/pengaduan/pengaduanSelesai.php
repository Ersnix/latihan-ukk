...
<div class="container">
	...
	<center>
		...
		<a class="btn btn-success" href="<?= BASEURL ?>/petugas/pengaduanSelesai">Pengaduan Selesai<i class="badge badge-light"><?php echo count($data[3]) ?></i></a>
	</center>
	<table border="1" class="table">
		...
		<tbody>
			...
			<td><a class="btn btn-success" href="<?= BASEURL ?>/petugas/laporanDetail/<?php echo $d['id_pengaduan']; ?>">Detail</a></td>
		</tbody>
	<?php 	endforeach; ?>
	</table>
</div>
